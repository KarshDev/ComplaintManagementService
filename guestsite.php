            ...
            <div id="body" style="background-color: #f8ffff; text-align:left:auto;margin: auto; margin-top: 10px; border: solid 1px #19b220; padding: 10px">
                ...
                <form role="form" method="post" action="index.php" novalidate="" >
                    ...
                    <div class="form-group">
                        ...
                        <input id="matric" type='text' name='mat_no' class="form-control" maxlength='60' placeholder="Enter Student Matric Number or Staff PF Number" required/>
                        <span id="matricError"></span>
                    </div>
                    <!-- name input-->
                    <div class="form-group">
                        <label for='fullname'>Fullname:</label>
                        <input id="fullname" type='text' name='fullname' class="form-control" maxlength='60' placeholder="Enter Fullname" required/>
                ...
                if(isset($_POST['submitBtn']))
                {
                    if (isset($_POST['mat_no']) && isset($_POST['fullname']) && ($_POST['category'] != '--Select Category--') && ($_POST['complaintType'] != '--Complaint Type--'))
                    {
                        ...
                        if($pre_num == 0){
                            $connection = mysql_connect('localhost','root','');
                            $db = mysql_select_db('id_cards',$connection);
                            $query = "INSERT INTO complaints(mat_no,full_name,category,complaint_type) VALUES('$mat_no','$fullname','$category','$complaint_type')";
